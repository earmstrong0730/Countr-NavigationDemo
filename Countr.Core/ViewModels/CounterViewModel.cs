...
namespace Countr.Core.ViewModels
{
    public class CounterViewModel : MvxViewModel<Counter>
    {
        ...
        public CounterViewModel(ICountersService service, IMvxNavigationService navigationService) //this is the real code
        {
            ...
            ClickCommandButton = new MvxAsyncCommand(ShowNextView);
        }

        public IMvxAsyncCommand IncrementCommand { get; }
        private MvxAsyncCommand _clickCommandButton;

        public MvxAsyncCommand ClickCommandButton
        {
            get => _clickCommandButton;
            set => SetProperty(ref _clickCommandButton, value);
        }
        ...
        async Task ShowNextView()
        {
            await navigationService.Navigate(typeof(MvxNavigatingObject));
        }
    }
}